    ...
    <Router>
      <div className="App-wrapper">
        ...
        <div className="App-content">
          <Routes>
            <Route path="/lesson1" element={<Lesson1 new_list={new_list} wordList={word_list} />} />
